...
# /Users/ml/Downloads/7_Fibo_A4_mod.jpg
# /Users/ml/Downloads/holamundo.jpg
if __name__ == '__main__':
	...
	img_path = input("Type absolute local path of flowchart image: ")

	# The best model is in folder 9 (training results)
	classifier = ShapeClassifier(
		results_path="model/training_results/9",
		use_gpu=False,
	...
	nodes = classifier.predict(image, display_image=True)
